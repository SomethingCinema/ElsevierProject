...
<body>
 ...
 <h2 class="intro">Meet our highly talented team of developers who bring their unique skills 
	...
	<div class="team-content">
	 ...
	 <div class="mem2">
	  <h3><b>Danielle Walsh:</b><i>Mathematician/Strategist/Developer</i></h3>
	  <a href="mailto:d.walsh@elsevier.com">d.walsh@elsevier.com</a>
	 </div>
	 <div class="mem3">
	  <h3><b>Eberechi Akoma:</b><i>Tester/Content Developer/Developer</i></h3>
	  <a href="mailto:e.akoma@elsevier.com">e.akoma@elsevier.com</a>
	 </div>
	 <div class="mem4">
	  <h3><b>Grace Alfieri :</b><i>UX/Content Developer/Developer</i></h3>
	  <a href="mailto:g.alfieri@elsevier.com">g.alfieri@elsevier.com</a>
	 </div>
	 <div class="mem5">
	  <h3><b>Rebecca Poch  :</b><i>Admin/Content Developer/Developer</i></h3>
