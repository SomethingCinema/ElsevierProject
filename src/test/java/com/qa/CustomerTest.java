...
public class CustomerTest {
	...
	public void changePasswordServiceTest(){
		int result = customerService.updatePassword("Mendham22", 2);
		assertThat(result, is(1));
	}
	
	@Test
	public void updateCustomerServiceTest(){
		int result = customerService.updateCustomer("Grace", "Alfieri", "g@gmail.com" , 1);
		assertThat(result, is(1));
	}
	...
	public void loginCustomerServiceTest(){
		...
		result = customerService.loginProcess("g@gmail.com", "Mendham5");
		assertNotNull(result);
	}
	
	@Test
	public void addCustomerServiceTest(){
		assertNotNull(customerService.add(customer2));
	}
