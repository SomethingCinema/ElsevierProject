...
public class AddressTest {
	...
	public void setUp() throws Exception{
		address = new Address();
		address.setAddressLine1("101 Spruce");
		address.setCity("Philadelphia");
		address.setCountry("USA");
		address.setPostcode("19103");
		address.setState("PA");
	...
	public void setAddressIdTest(){
		...
		assertThat(address.getAddressId(), is(10));
	...
	public void getAddressLine1Test(){
	 ...
	 assertThat(address.getAddressLine1(), is("101 Spruce"));
	}
	...
	public void updateBillingAddressTest(){
		int actualResult = addressService.updateBillingAddress("225 South 18th Street", "Unit 411B", "Philadelphia", "19103", "Pennsylvania", "USA", "2019102349", address.getAddressId(), "billing");
